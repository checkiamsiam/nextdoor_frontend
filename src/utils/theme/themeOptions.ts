...
export const shadows: Shadows = [
  ...
  "0px 9px 18px rgba(0, 0, 0, 0.04)",
  "0px 10px 20px rgba(0, 0, 0, 0.04)",
  "0px 11px 22px rgba(0, 0, 0, 0.04)",
  "0px 12px 24px rgba(0, 0, 0, 0.04)",
  "0px 13px 26px rgba(0, 0, 0, 0.04)",
  ...
  "0px 19px 38px rgba(0, 0, 0, 0.04)",
  "0px 20px 40px rgba(0, 0, 0, 0.04)",
  "0px 21px 42px rgba(0, 0, 0, 0.04)",
  "0px 22px 44px rgba(0, 0, 0, 0.04)",
  "0px 23px 46px rgba(0, 0, 0, 0.04)",
