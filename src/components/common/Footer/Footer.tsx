        ...
        <Grid container spacing={2} sx={{ py: 5 }}>
          ...
          <Grid item md={2.8} xs={12} sm={6}>
            <Stack spacing={2}>
              ...
              <FooterLink href="/">
                BD Electronics, 2nd Floor, Rupa Tower, Jhalkuri, Narayangang
              </FooterLink>
              <FooterLink href="/">
                Zam Electronics, 2nd Floor, RS Shoping Complex, Jatrabari
              </FooterLink>
              <FooterLink href="/">Email: info@nextdoorbd.shop</FooterLink>
            </Stack>
          </Grid>
        </Grid>
        <hr />
